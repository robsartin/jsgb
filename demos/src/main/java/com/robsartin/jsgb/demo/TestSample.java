 ...
 * be compared with {@code sample.correct}. {@link #run} grows one stanza at a time as generators
...
public final class TestSample {
  ...
  /** Runs the sample sequence ported so far, writing {@code test.gb} in the current directory. */
  public static void main(String[] args) {
    run(new PrintStream(System.out, true, StandardCharsets.ISO_8859_1), Path.of(""));
  }

  /**
   * Runs the sample sequence ported so far, in {@code test_sample.w} order, printing to {@code out}
   * and writing {@code test.gb} under {@code workDir}.
   */
